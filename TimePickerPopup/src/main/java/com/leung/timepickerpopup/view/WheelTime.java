package com.leung.timepickerpopup.view;

import android.view.View;

import com.contrarywind.listener.OnItemSelectedListener;
import com.contrarywind.view.WheelView;
import com.leung.timepickerpopup.R;
import com.leung.timepickerpopup.adapter.ArrayWheelAdapter;
import com.leung.timepickerpopup.adapter.NumericWheelAdapter;
import com.leung.timepickerpopup.listener.ISelectTimeCallback;
import com.leung.timepickerpopup.utils.ChinaDate;
import com.leung.timepickerpopup.utils.LunarCalendar;
...
public class WheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        //wv_hours.setLabel(context.getString(R.string._xpopup_ext_hours));// 添加文字
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);

        wv_minutes = (WheelView) view.findViewById(R.id.min);
        wv_minutes.setAdapter(new NumericWheelAdapter(0, 59));
        //wv_minutes.setLabel(context.getString(R.string._xpopup_ext_minutes));// 添加文字
        ...
        //wv_seconds.setLabel(context.getString(R.string._xpopup_ext_minutes));// 添加文字
...
//                maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_year != null) {
            ...
            wv_year.setLabel(view.getContext().getString(R.string._xpopup_ext_year));
        }
        if (label_month != null) {
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string._xpopup_ext_month));
        }
        if (label_day != null) {
            wv_day.setLabel(label_day);
        } else {
            wv_day.setLabel(view.getContext().getString(R.string._xpopup_ext_day));
        }
        if (label_hours != null) {
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string._xpopup_ext_hours));
        }
        if (label_mins != null) {
            wv_minutes.setLabel(label_mins);
        } else {
            wv_minutes.setLabel(view.getContext().getString(R.string._xpopup_ext_minutes));
        }
        if (label_seconds != null) {
            wv_seconds.setLabel(label_seconds);
        } else {
            wv_seconds.setLabel(view.getContext().getString(R.string._xpopup_ext_seconds));
        }
